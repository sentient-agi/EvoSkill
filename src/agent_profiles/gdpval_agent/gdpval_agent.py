...
def make_gdpval_agent_options(model: str | None = None, provider: str | None = None, data_dir: str | None = None):
    ...
    def factory() -> Union[ClaudeAgentOptions, dict]:
        return get_gdpval_agent_options(model=model, provider=provider, data_dir=data_dir)
    return factory
